...
def proc_logging(id, info, train_info):
    info = "[CNN Result for test_session="+str(id)+"] "+info
    path = "./log/CNN/"+train_info+"/"
...
def train(id, bs=256, ne=100, lr=0.001, train_info=""):
    ...
    for epoch in range(n_epoch):
        ...
        '''save model'''
        save_path = "./model/CNN/"+train_info+"/"
...
if __name__=="__main__":
    ...
    os.system("rm -r ./log/CNN/"+train_info+"/")
    os.system("rm -r ./model/CNN/"+train_info+"/")
