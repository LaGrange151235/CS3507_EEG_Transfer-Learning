...
def proc_logging(id, info, train_info):
    info = "[MixStyle_CNN Result for test_session="+str(id)+"] "+info
    path = "./log/MixStyle_CNN/"+train_info+"/"
...
def global_logging(info, train_info):
    info = "[MixStyle_CNN Final Result] "+info
    path = "./log/MixStyle_CNN/"+train_info+"/"
...
def train(id, bs=256, ne=100, lr=0.001, train_info=""):
    ...
    for epoch in range(n_epoch):
        ...
        '''save model'''
        save_path = "./model/MixStyle_CNN/"+train_info+"/"
...
if __name__=="__main__":
    ...
    os.system("rm -r ./log/MixStyle_CNN/"+train_info+"/")
    os.system("rm -r ./model/MixStyle_CNN/"+train_info+"/")
