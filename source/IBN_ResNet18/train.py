...
#
    ...
    print("[IBN_RestNet18 Final Result] total_models: %d, avg_train_acc: %.4f, train_acc_std:%.4f, avg_test_acc: %.4f, test_acc_std: %.4f" % (len(test_acc_list), avg_train_acc, std_train_acc, avg_test_acc, std_test_acc))